...
Configurez votre environnement de développement comme décrit dans la section 1.

Abordez un nouveau concept en consultant le chapitre correspondant dans le Socle Théorique.

Mettez en pratique la notion étudiée en tentant de résoudre les problèmes associés dans le Livret d'exercices, avant d'en consulter la correction.

Utilisez l'interactivité des notebooks pour tester des cas limites sur les algorithmes fournis.
